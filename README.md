...
This application has been used as an example in the following article: <https://www.playingaws.com/posts/how-to-create-serverless-applications-with-sam/>

## Steps to create this SAM project

```
sam init
> Choose standalone function (now, number 6 - it will change in the future)
> runtime: nodejs20.x
> Enable X-Ray: y
> project name: sam-app
```

## Autogenerated README from standalone function template
